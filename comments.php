...
<section id="comments" aria-label="<?php esc_attr_e( 'Comments', 'ipin' ); ?>">
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav aria-label="<?php esc_attr_e( 'Comment pages', 'ipin' ); ?>">
			<ul class="pager" role="list">
				<li class="previous"><?php previous_comments_link( '<span aria-hidden="true">&laquo;</span> ' . esc_html__( 'Older Comments', 'ipin' ) ); ?></li>
				<li class="next"><?php next_comments_link( esc_html__( 'Newer Comments', 'ipin' ) . ' <span aria-hidden="true">&raquo;</span>' ); ?></li>
			</ul>
		</nav>
		<?php endif; ?>
	...
	comment_form( [
		...
		'comment_field'        =>
			'<div>'
			. '<label for="comment">' . esc_html__( 'Comment', 'ipin' ) . ' <span aria-hidden="true">*</span><span class="sr-only">' . esc_html__( 'required', 'ipin' ) . '</span></label>'
